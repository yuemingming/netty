...
public class ServerBootstrap extends AbstractBootstrap<ServerBootstrap, ServerChannel> {
    ...
    void init(Channel channel) throws Exception {
        ...
        p.addLast(new ChannelInitializer<Channel>() {
            ...
            public void initChannel(final Channel ch) throws Exception {
                ...
                // 添加 ServerBootstrapAcceptor 到pipeline 中
                // 使用 EventLoop 的原因，参见https://github.com/lightningMan/netty/commit/4638df20628a8987c8709f0f8e5f3679a914ce1a
    ...
    private static class ServerBootstrapAcceptor extends ChannelInboundHandlerAdapter {
        ...
        public void channelRead(ChannelHandlerContext ctx, Object msg) {
            ...
            // 添加 NioSocketChannel 处理器。
            child.pipeline().addLast(childHandler);
            // 设置 NioSocketChannel 的配置项
            setChannelOptions(child, childOptions, logger);
            // 设置 NioSocketChannel 属性
            for (Entry<AttributeKey<?>, Object> e: childAttrs) {
                child.attr((AttributeKey<Object>) e.getKey()).set(e.getValue());
            }

            try {
                // 注册客户端 NioSocketChannel 到 work EventLoop 中
