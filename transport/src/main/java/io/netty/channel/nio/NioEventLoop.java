...
public final class NioEventLoop extends SingleThreadEventLoop {
    ...
    private SelectorTuple openSelector() {
        ...
        // 设置 SelectedSelectionKeySet 对象到 unwrapppedSelector 中
        Object maybeException = AccessController.doPrivileged(new PrivilegedAction<Object>() {
            @Override
            public Object run() {
                try {
                    //获得 "selectKeys" "publicSelectedkeys" 的 Field
    ...
    private void rebuildSelector0() {
        ...
        // 将注册在 NioEventLoop 上的所有Channel，注册到新创建 Selector 对象上
        ...
        for (SelectionKey key: oldSelector.keys()) {
            ...
            try {
                ...
                // 修改 Channel 的 SelecctionKey 指向新的 SelectionKey 上
        ...
        for (;;) {
            try {
                try {
                    ...
                    case SelectStrategy.CONTINUE://默认实现下不存在这个情况
                        continue;
    ...
    private void select(boolean oldWakenUp) throws IOException {
        ...
        try {
            ...
            for (;;) {
                ...
                //如果超时时长，则结束 select
                if (timeoutMillis <= 0) {
                    if (selectCnt == 0) { // 如果首次 select，selectNow 一次，非阻塞
                        selector.selectNow();
                        selectCnt = 1;
                    }
                    break;
                ...
                // 阻塞select， 查询 channel 是否有就绪的 IO 事件。
                ...
                if (time - TimeUnit.MILLISECONDS.toNanos(timeoutMillis) >= currentTimeNanos) {
                    ...
                    selector = selectRebuildSelector(selectCnt); // 重建 selectCnt 为1
                    selectCnt = 1;//重置 selectCnt 为 1
                    break;// 结束 select
                }
